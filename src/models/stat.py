...
class Stat:
def **init**(self, usage_point_id, measurement_direction=None):
“””
...
def tempo(self, i):
    ...
    # Si les données Tempo incluent des détails par couleur
...
def yesterday_hc_hp(self):
    ...
    begin, end = self._get_period(1)  # 1 = hier
...
def yesterday_evolution(self):
    ...
    yesterday = self.daily(1)["value"]  # Hier
    last_week_same_day = self.daily(8)["value"]  # Même jour semaine dernière
